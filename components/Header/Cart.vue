...
<template>
  <nav class="bg-[#171a21] text-white w-full sticky top-0 left-0" style="z-index: 999999">
    <div  class="px-4 flex items-center justify-start mx-auto py-4 ">
      <div class="flex">
        <button
            type="button"
