<template>
  ...
  <div class="shadow-lg rounded-md border border-neutral-100">
    ...
    <div class="px-4 pb-4 mt-3 md:px-6 md:pb-6 md:mt-0">
      <div class="flex justify-between typography-text-base pb-4">
        ...
        <div class="flex flex-col text-right">
          ...
          <p class="typography-text-xs text-secondary-700">{{ formatPrice(orderDetails.savings) }}</p>
                      <p class="my-2">{{ paymentMethod.label=='' ? 'Not selected':paymentMethod.label }}</p>
      ...
      <SfButton :disabled="paymentMethod.value == ''" size="lg" class="w-full bg-[#ff346d] hover:bg-[#3b82f6] ">
