    ...
    <div class="mb-4 border-b border-gray-200 dark:border-gray-700">
      <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="default-tab" role="tablist">
        <li class="me-2" role="presentation">
          <NuxtLink to="/dash-board/orders" class="inline-block p-4 border-b-2 rounded-t-lg" id="profile-tab" type="button" role="tab">{{ $t('dashBoardPage.orders.title') }}
          </NuxtLink>
        </li>
        <li class="me-2" role="presentation">
          <NuxtLink to="/dash-board/game-library" class="inline-block p-4 border-b-2 rounded-t-lg" id="profile-tab" type="button" role="tab">{{ $t('dashBoardPage.gameLibrary.title') }}
          </NuxtLink>
        </li>
